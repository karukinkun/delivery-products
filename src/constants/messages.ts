...
export const pageMsg = {
  ...
  passkeyAuthSetup: {
    title: '生体認証ログイン設定',
    whatIsPasskeyTitle: '生体認証とは',
    intro: '生体認証を登録すると、対応端末では顔認証や指紋認証などで簡単にログインできます。',
    whatIsPasskeyBody:
      '・端末やブラウザに紐づく鍵を使い、パスワードの入力を省略できます。\n' +
      '・公開鍵暗号方式（FIDO2／WebAuthn）に基づき、偽サイトへの流出に強い仕組みです。\n' +
      '・認証は、端末の顔認証・指紋認証、または端末のPIN／パスコードなどで行います。',
    currentStatusLabel: '現在の設定',
    statusRegistered: 'この端末の生体認証設定は登録済みです',
    statusNotRegistered: 'この端末の生体認証設定は未登録です',
  },
};
...
export const buttonMsg = {
  ...
  toTop: 'トップページへ',
  toUserInfo: '会員情報変更',
  toAddressList: 'お届け先変更',
  toFavoriteProducts: 'お気に入り商品一覧',
  toPaymentMethods: 'お支払い方法変更',
  toOrderHistory: '注文履歴',
  toPasskeyAuthSetup: '生体認証設定（簡単ログイン）',
  backToMypage: 'マイページへ戻る',
  registerPasskey: '生体認証を登録する',
  removePasskey: '生体認証を解除する',
};
