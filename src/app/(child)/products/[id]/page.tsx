import { AddToCartButton } from '@/app/(child)/products/[id]/_components/AddToCartButton';
import RatingList from '@/app/(child)/products/[id]/_components/rating-list';
      ...
      <div className="mx-auto w-full max-w-5xl px-4 py-6">
        <div className="flex w-full min-w-0 flex-col justify-center gap-4 sm:flex-row">
          <div className="mx-auto w-[80%] max-w-full min-w-0 overflow-hidden md:w-[50%]">
            <ImageSwiper images={product.images} alt="商品サムネイル" />
          </div>
